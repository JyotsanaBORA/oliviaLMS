...
name: ponytail
description: >
  Forces the laziest solution that actually works: simplest, shortest, most minimal code.
  Channels a senior developer who questions over-engineering (YAGNI), reaches for standard libraries,
  native platform features, and one-liners before writing custom code.
  Use when asked for lazy mode, simplest/minimal solution, YAGNI, or when avoiding over-engineering/bloat.
