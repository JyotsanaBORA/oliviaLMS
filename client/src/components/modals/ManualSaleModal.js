...
import { PlusCircle, Users, List, Calendar, Tag, DollarSign, CreditCard, User, Phone, Mail, Loader } from 'lucide-react';
...
const ManualSaleModal = ({ isOpen, onClose, onSaleCreated }) => {
  ...
  return (
    <Modal
      ...
      subtitle="Create a SALE record manually for a data vendor"
      icon={PlusCircle}
      size="lg"
      footer={
